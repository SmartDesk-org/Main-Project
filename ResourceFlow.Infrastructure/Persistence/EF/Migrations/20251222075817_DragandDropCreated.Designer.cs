...
namespace ResourceFlow.Infrastructure.Persistence.EF.Migrations
{
    ...
    [Migration("20251222075817_DragandDropCreated")]
    partial class DragandDropCreated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.Authentication.Roles", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 12, 22, 7, 58, 16, 279, DateTimeKind.Utc).AddTicks(8923),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 12, 22, 7, 58, 16, 279, DateTimeKind.Utc).AddTicks(8928),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2025, 12, 22, 7, 58, 16, 279, DateTimeKind.Utc).AddTicks(8930),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.Authentication.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2025, 12, 22, 7, 58, 16, 654, DateTimeKind.Utc).AddTicks(7216),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            ...
                            IsDelete = false,
                            ModifiedBy = 0,
                            PassWord = "$2a$11$se9dF6nLHC2rnQD.9cShTu34PlM6GegORyl1WS4OmSNS5IXnOL4DO",
                            RefreshToken = "",
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.CompanyModels.CompanyDesk", b =>
                {
                    ...
                    b.HasIndex("FloorId", "XPosition", "YPosition");

                    b.ToTable("CompanyDesks", (string)null);
                });

            modelBuilder.Entity("ResourceFlow.Domain.Entities.CompanyModels.CompanyDetails", b =>
                {
                    b.Property<int>("CompanyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Billing", b =>
                {
                    b.HasOne("ResourceFlow.Domain.Entities.CompanyModels.CompanyDetails", "Company")
                        .WithMany()
