...
namespace ResourceFlow.Infrastructure.Persistence.EF.Migrations
{
    ...
    [Migration("20251204093117_AddPasswordResetColumns")]
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.Authntication.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateAt = new DateTime(2025, 12, 4, 9, 31, 14, 343, DateTimeKind.Utc).AddTicks(7674),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
                        ...
                        {
                            Id = 2,
                            CreateAt = new DateTime(2025, 12, 4, 9, 31, 14, 343, DateTimeKind.Utc).AddTicks(7681),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
                        ...
                        {
                            Id = 3,
                            CreateAt = new DateTime(2025, 12, 4, 9, 31, 14, 343, DateTimeKind.Utc).AddTicks(7684),
                            CreatedBy = 0,
                            DeletedBy = 0,
                            IsDelete = false,
                            ModifiedBy = 0,
            ...
            modelBuilder.Entity("ResourceFlow.Domain.Entities.Authntication.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PassWord = "$2a$11$21rP/cc9uSAbrnpN1O.GieHPyaxxW4lLj2keb1PjEiZKaMcV1a4Eq",
                            RefreshToken = "",
